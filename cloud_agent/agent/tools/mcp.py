"""MCP client: connects to MCP servers and wraps their tools as native cloud_agent tools."""
...
from cloud_agent.agent.tools.base import Tool
from cloud_agent.agent.tools.registry import ToolRegistry


class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a cloud_agent Tool."""
