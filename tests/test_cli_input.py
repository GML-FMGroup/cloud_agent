...
from cloud_agent.cli import commands
...
def mock_prompt_session():
    ...
    with patch("cloud_agent.cli.commands._PROMPT_SESSION", mock_session), \
         patch("cloud_agent.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("cloud_agent.cli.commands.PromptSession") as MockSession, \
         patch("cloud_agent.cli.commands.FileHistory") as MockHistory, \
